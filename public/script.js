    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (input.hasAttribute('required') && value === '') {
                const fieldName = input.getAttribute('data-name') || name || 'This field';
            ...
            if (input.hasAttribute('pattern')) {
                ...
                if (value !== '' && !pattern.test(value)) {
                    ...
                    showError(input, patternMessage);
                    return false;
                }
            }
                ...
                fetch(formAction, fetchOptions)
                    ...
                    .then(function() {
                        ...
                        if (successMessage) {
                            ...
                            successEl.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background-color: #f0fff4; border: 1px solid #38a169; border-radius: 0.375rem;';
                    ...
                    .catch(function(error) {
                        const errorMessage = contactForm.querySelector('.form-global-error');
                        if (errorMessage) {
                            errorMessage.style.display = 'block';
                        } else {
                            const errorEl = document.createElement('div');
                            errorEl.className = 'form-global-error';
                            errorEl.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background-color: #fff5f5; border: 1px solid #e53e3e; border-radius: 0.375rem;';
        ...
        const mutationObserver = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                mutation.addedNodes.forEach(function(node) {
                    if (node.nodeType === 1) {
                        if (node.matches && node.matches('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right, .animate-on-scroll')) {

                            animationObserver.observe(node);
                        } else if (node.querySelectorAll) {
                            const nestedElements = node.querySelectorAll('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right, .animate-on-scroll');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6608bc53-d7b2-40e8-80a1-8a86cca20feb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6608bc53-d7b2-40e8-80a1-8a86cca20feb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6608bc53-d7b2-40e8-80a1-8a86cca20feb';
